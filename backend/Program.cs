...
builder.Services.AddCors(options =>
{
    ...
    {
        policy.WithOrigins("http://localhost:3000", "http://frontend:3000", "https://test-thai-beverage-580297340291.europe-west1.run.app", "https://front-test-thai-beverage-580297340291.europe-west1.run.app/")
              .AllowAnyHeader()
              .AllowAnyMethod()
              .AllowCredentials();
    });
